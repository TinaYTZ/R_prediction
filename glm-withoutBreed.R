...
popularBreeds <- names(summary(outcome.train$Breed,maxsum=10L))
...
#SexuponOutcome
glm.fitA=glm(resultA~hasName+dog+cat+AgeinDays+Year+Weekday+Hour+TimeValue+SexuponOutcome, data = outcome.train, family = binomial )
...
#fit a logistic regression model using outcome.training data
glm_fitD=glm(resultD~hasName+dog+cat+AgeinDays+Year+Weekday+Hour+TimeValue+SexuponOutcome, data = outcome.train, family = binomial )
...
#fit a logistic regression model using outcome.training data
glm_fitE=glm(resultE~hasName+dog+cat+AgeinDays+Year+Weekday+Hour+TimeValue+SexuponOutcome, data = outcome.train, family = binomial )
...
#fit a logistic regression model using outcome.training data
glm_fitR=glm(resultR~hasName+dog+cat+AgeinDays+Year+Weekday+Hour+TimeValue+SexuponOutcome, data = outcome.train, family = binomial )
...
#fit a logistic regression model using outcome.training data
glm_fitT=glm(resultT~hasName+dog+cat+AgeinDays+Year+Weekday+Hour+TimeValue+SexuponOutcome, data = outcome.train, family = binomial )
