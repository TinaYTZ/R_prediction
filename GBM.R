library(lubridate)
library(gbm)
read.csv('/Users/Tina/Documents/R_Studio/GroupP/train.csv') -> train
read.csv('/Users/Tina/Documents/R_Studio/GroupP/test.csv') -> test
...
testPreds2 <- predict(gbm1,test,type="response", n.trees=trees)
...
write.csv(ss,file="submission.csv",row.names=FALSE)